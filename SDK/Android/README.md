...
Copy sms-api-android-sdk-1.0.0.jar from the `target` folder and all other libraries located in `target/lib` to your project's lib folder.
...
// create a client
final APIPRODcosmicsmsClient client = factory.build(APIPRODcosmicsmsClient.class);

// Invoke your clickAccountBalancePost method
 output = client.clickAccountBalancePost();

// you also have access to your API models
Error myModel = new Error();
